...
public partial class MainViewModel : BaseViewModel
{
    ...
    // I'm using the publish-subscribe pattern here 
    ...
    private void SaveScore()
    {
        ...
        if (player != null)
        {
            ...
            // Raise the PlayerScoreUpdated event using the SaveScoreEventHandler instance
            SaveScoreEventHandler.Instance.OnPlayerScoreUpdated();
        }
    }
